...
python3 g4_train.py --name 'FS2_DS4_GnetDS4_K35_ngf64_AUG2_WOtrainLoss' --model Gnet_DS4 --gpu_ids 1 --k_shot 30 --lr 0.0001 --DSrate 4  --ngf 64 --dataroot './../../mrdata/T1w_pad_32ch_halfnY_std' --nEpoch 250 --Aug  #--test_mode
