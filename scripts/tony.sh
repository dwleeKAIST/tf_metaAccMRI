...
python3 g_train.py --name 'DS2_meta_K5_ngf512'  --model Gnet_ --dataset '7T' --batchSize 1 --lr 0.005 --gpu_ids 0 --k_shot 5 --DSrate 2 --nEpoch_state_update 1 --nEpoch_Wb_update 1 --ngf 512  #--smallDB  #--debug_mode
