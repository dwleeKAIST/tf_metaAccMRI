...
python3 g4_train.py --name 'FS2_DS4_GnetDS4_K30_ngf128_AUG2' --model Gnet_DS4  --gpu_ids 0 --lr 0.0001  --k_shot 30 --DSrate 4  --ngf 128 --dataroot './../../mrdata/T1w_pad_32ch_halfnY_std' --nEpoch 250  --Aug  # --test_mode 
